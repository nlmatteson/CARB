...
# %% Read In Raw Table
# rancho cucamonga
test = 'city-rancho_cucamonga-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())
# %% List Desired Fields

fields = ['Date', 'Record Number', 'Record Type', 'Application Name', 'Address']
...
out_df['place'] = 'Rancho Cucamonga city'
...
out_df['project_description'] = df.loc[:,'Application Name']
