...
# %% Read In Raw Table
# west sacramento
test = 'city-west_sacramento-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())

# %% List Desired Fields
fields= ['Permit #', 'Date', 'Permit Type',
'Address', 'Description', 'Status', 'Short Notes']
...
out_df['place'] = 'West Sacramento city'
...
out_df['permit_number'] = df.loc[:,'Permit #']
...
out_df['permit_type'] = df.loc[:,'Short Notes']
