...
test = 'county-san_bernardino-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())

# %% List Desired Fields
fields= ['Record Number', 'Record Type', 'Address', 'Description',
'Status', 'Related Records', 'Project Name', 'Date']
...
out_df['county_name'] = 'San Bernardino County'
