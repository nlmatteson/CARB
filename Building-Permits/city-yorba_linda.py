...
# %% Read In Raw Table
# yorba linda
test = 'city-yorba_linda-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())

# %% List Desired Fields
fields= ['Date', 'Record Number', 'Record Type',
'Project Name', 'Address', 'Status', 'Short Notes']
...
# %% Populate permit description
df['full_desc']= (df['Project Name'].astype(str) + ', ' + df['Short Notes'].astype(str))
