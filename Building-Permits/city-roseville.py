...
# %% Read In Raw Table
# roseville data
test = 'city-roseville-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())
# %% List Desired Fields

fields = ['Record Number', 'Submitted Date',
'Address', 'Record Type', 'Project Name']
