...
# %% Read In Raw Table
# fresno data
test = 'city-fresno-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())

# %% List Desired Fields
fields= ['Record', 'Applied On', 'Record Type',
'Status', 'Address', 'Description', 'Project Name']
...
out_df['permit_number'] = df.loc[:,'Record']
...
out_df ['applied_date'] = df.loc[:,'Applied On']
