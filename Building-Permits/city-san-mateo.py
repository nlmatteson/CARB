...
# %% Read In Raw Table
# san mateo data
test = 'city-san_mateo-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())
# %% List Desired Fields

fields = ['Case Number', 'Type', 'Status', 'Project Name', 'Issued Date', 'Applied Date',
'Finalized Date', 'Module Name', 'Address', 'Main Parcel', 'Description']
