...
# %% Read In Raw Table
# richmond data
test = 'city-richmond-final.csv'
raw = pd.read_csv(root + test)
print(raw.columns.to_list())
# %% List Desired Fields

fields = ['DESCRIPTION OF WORK', 'Site Address',
'Parcel Number', 'Permit Type', 'Permit Subtype', 'RECORDID']
...
out_df['project_description'] = df.loc[:,'DESCRIPTION OF WORK']

# %% Populate Permit Class Field
out_df['permit_type'] = df.loc[:,'Permit Subtype']
